...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:p0MRzyhokJ9Kn5jcJAHNup0s+COMBPfn1mTasls6mMg=",
        version = "v0.19.5",
    )
    go_repository(
        ...
        sum = "h1:Yvz6dOE0WbVE+FXBEFqc9lSvo87VPtq6mCSsrtC95HI=",
        version = "v0.19.5",
    )
    go_repository(
        name = "io_k8s_client_go",
        importpath = "k8s.io/client-go",
        sum = "h1:Y7LsFwgbm9+5oVXER04KNCSPhY6TblYRgG1DQdVq+ig=",
        version = "v0.19.5",
    )
    go_repository(
        name = "io_k8s_gengo",
